...
description: 'Generating efficient switch-like dispatch from parameter packs, from function tables and macros through folds and C++26 expansion statements.'
pubDate: 2025-05-13T02:20:00+00:00
categories: [C++]
...
While it's not yet approved for inclusion in C++26 at the time of writing, one interesting candidate is expansion statements from [P1306](https://wg21.link/p1306). I've mentioned expansion statements in [C++26 Expansion Tricks](/articles/expansion-tricks/) before, but originally missed its usefulness for this particular problem.
