...
description: 'Implementing keyword arguments in C++ by abusing reflection.'
pubDate: 2025-02-09T04:20:29+01:00
categories: [C++]
tags: [C++, C++26, reflection, experiments]
toc: true
heroImage: ./reflection-reflection-everywhere.jpg
heroImageAlt: Reflection, reflection everywhere
outdated: 'Some of the features this post is about have changed since this post was written, and GCC chose the implementation freedom to not expose lambda captures at all.'
showcase: hide
---
...
![Reflection, reflection everywhere!](./reflection-reflection-everywhere.jpg)
...
Good we can get types of lambda captures and references are properly handled. Even better, we can splice in the respective member to access captures outside of the lambda (for now.. see [P3587](https://wg21.link/p3473)). Bad news though, the members are all unnamed.
